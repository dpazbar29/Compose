package contextMenuComposeDesktop
...
@Composable
fun JPopupTextMenuProvider(
    owner: Component,
    content: @Composable () -> Unit,
) {
    val localization = LocalLocalization.current
    CompositionLocalProvider(
        LocalTextContextMenu provides
            JPopupTextMenu(owner) { textManager, items ->
                JPopupMenu().apply {
...
private fun circleIcon(color: Color) =
    object : Icon {
